...
local Section = Tab:NewSection("Crash Server installe un Auto clicker")
Section:NewButton("Crash server", "mais l auto cliker sur le bouton tu dois aoir 19miliard", function()
    local args = {
    [1] = "Jet"
    }
